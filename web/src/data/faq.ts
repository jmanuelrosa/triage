...
export const faqEntries: FaqEntry[] = [
  ...
  },
  {
    ...
    answerHtml:
      "Not yet — v0.1.1 ships unsigned. Homebrew users get the quarantine attribute stripped automatically. DMG users need to right-click Triage.app and choose Open the first time. Code signing and notarization are on the roadmap before the 1.0 release.",
  },
];
